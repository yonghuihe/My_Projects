...
<html>
	<head>
		...
		<script type="text/javascript" src="/js/plugins/uploadify/jquery.uploadify.min.js?f=<%=System.currentTimeMillis()%>"></script>
		...
		<script type="text/javascript">
			$(function(){
				$("#btn_uploadUserFiles").uploadify({
					...
					//formDate:{logininfoId:4},//直接将当前登录对象的id传到后台不安全，推荐使用上面的jsessionid
