	...
	<body>
		...
		<div class="container">
			<div class="row">
				...
				<!-- 功能页面 -->
				<div class="col-sm-9">
					<form id="searchForm" class="form-inline" method="post" action="/bid_list.do">
					...
					<div class="panel panel-default" style="margin-top:20px">
						<div class="panel-headin">投标项目</div>
						<table class="table table-striped">
							...
							<tbody>
								<#list pageResult.result as data>
									<tr>
										<td>
											<a target="_blank" href="/borrow_info.do?id=${data.id}">${(data.bidRequestTitle)!''}</a></span>
										</td>
