...
<body>
	...
	<div class="container">
	    <div class="row">
	        ...
	        <!-- 功能页面 -->
	        <div class="col-sm-9">
	            <form action="/recharge_list.do" method="post" name="searchForm" id="searchForm" class="form-inline">
	            ...
	            <div class="panel panel-default">
	                <div class="panel-heading">
	                    ...
	                    <a class="pull-right btn btn-danger btn-sm" href="/rechargeOffline.do">
	                        	账户充值
	                    </a>
	                ...
	                <table class="table">
	                    ...
	                    <tr>
	                        <td>
	                            <div class="bank bank_${data.bankInfo.bankname}"></div>
	                        </td>
