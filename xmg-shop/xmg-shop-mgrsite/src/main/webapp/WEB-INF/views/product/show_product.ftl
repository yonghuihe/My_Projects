							...
							<div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane" id="sku">
									<div id="productSkuPanel" style="padding-bottom: 10px; padding-left: 10px; padding-right: 10px; padding-top: 10px;">
										商品名称：<a href="#">${product.name}</a><br/>
										商品编号：<a href="#">${product.code}</a>
										<table class="table table-hover">
											<thead>
												<tr>
													<th>sku编号</th>
													<th>价格</th>
													<!-- 只需要遍历第一条sku里的sku属性就可以了，不然的话会重复 -->
													<#-- <#list productSkuList[0].productSkuPropertyList as data>
														<th>${data.skuProperty.name}</th>
													</#list> -->
