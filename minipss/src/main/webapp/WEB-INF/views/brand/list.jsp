				...
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_bottom">
							...
							<input type="button" value="新增" class="ui_input_btn01 btn_redirect" data-url='<s:url action="brand_input" />'/> 
						</div>
					</div>
				</div>
			</div>
							...
							<s:iterator value="#result.result" var="item">
								<tr>
									...
									<td>
										...
										<s:a action="brand_delete"><s:param name="brand.id" value="#item.id"/>删除</s:a>
									</td>
								</tr>
							</s:iterator>
						</tbody>
