...
<s:form name="editForm" action="brand_save" method="post" id="editForm">
	<div id="container">
		<div id="nav_links">
		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
					<td class="ui_text_rt" width="140">品牌说明</td>
					<td class="ui_text_lt">
						<s:textfield name="brand.description" cssClass="ui_input_txt02"/>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
