		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
					...
					<td class="ui_text_lt">
						<s:select list="#depts" cssClass="ui_select01" name="employee.dept.id" listKey="id" listValue="name"/>
					</td>
				</tr>
				<s:if test="#isAdmin">
				<tr>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<table>
							<tr>
								<td>
									<s:select name="allRoles" list="#roles" listKey="id" listValue="name" multiple="true" cssClass="ui_multiselect01 all_roles"></s:select>
								</td>
								<td align="center">
