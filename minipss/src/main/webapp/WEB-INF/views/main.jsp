...
<body>
			...
			<div id="top_op">
				<ul>
					<li>
						...
						<span><s:property value="#session.USER_NAME" /></span>
					</li>
					<li>
    ...
    <!-- side menu start -->
    <div id="top_nav">
	 	<span id="here_area">当前位置：系统&nbsp;>&nbsp;员工管理</span>
	</div>
    <div id="main">
      	<iframe name="right" id="rightMain" src="employee.action" frameborder="no" scrolling="auto" width="100%" height="100%" allowtransparency="true"/>
    </div>
</body>
</html>
