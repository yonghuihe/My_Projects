					...
					<td class="ui_text_lt">
						<table>
							<tr>
								...
								<td align="center">
									<input type="button" class="select" value="-->"/><br/>
									<input type="button" class="selectAll" value="==>"/><br/>
									<input type="button" class="deselect" value="<--"/><br/>
									<input type="button" class="deselectAll" value="<=="/>
								</td>
								<td>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<table>
							<tr>
								<td>
									<s:select list="#menus" listKey="id" listValue="name" multiple="true" cssClass="ui_multiselect01 all_menus"></s:select>
								</td>
								<td align="center">
									<input type="button" class="mselect" value="-->"/><br/>
									<input type="button" class="mselectAll" value="==>"/><br/>
									<input type="button" class="mdeselect" value="<--"/><br/>
									<input type="button" class="mdeselectAll" value="<=="/>
								</td>
								<td>
									<s:select name="role.menus.id" list="role.menus" listKey="id" listValue="name" multiple="true" cssClass="ui_multiselect01 selected_menus"></s:select>
								</td>
							</tr>
						</table>
					</td>
