			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
					<tr>
						...
						<td class="ui_text_lt">
							<s:textfield disabled="true" name="orderBill.sn" cssClass="ui_input_txt02"/>
						</td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">供应商</td>
						<td class="ui_text_lt">
							<s:select list="#suppliers" disabled="true" name="orderBill.supplier.id" listKey="id" listValue="name" cssClass="ui_input_txt04"/>
						</td>
					</tr>
					<tr>
						...
						<td class="ui_text_lt">
							...
							<s:textfield disabled="true" name="orderBill.vdate" value="%{#datefmt}" cssClass="ui_input_txt02"/>
						</td>
					</tr>	
					<tr>
