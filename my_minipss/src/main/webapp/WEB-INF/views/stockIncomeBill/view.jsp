			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
					<tr>
						...
						<td class="ui_text_lt">
							<s:textfield disabled="true" name="stockIncomeBill.sn" cssClass="ui_input_txt02"/>
						</td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">仓库</td>
						<td class="ui_text_lt">
							<s:select list="#depots" disabled="true" name="stockIncomeBill.depot.id" listKey="id" listValue="name" cssClass="ui_input_txt04"/>
						</td>
					</tr>
					<tr>
						...
						<td class="ui_text_lt">
							...
							<s:textfield disabled="true" name="stockIncomeBill.vdate" value="%{#datefmt}" cssClass="ui_input_txt02"/>
						</td>
					</tr>	
					<tr>
	                        ...
	                        <table class="edit_table" cellspacing="0" cellpadding="0" border="0" style="width: auto">
	                            ...
	                            <tbody id="edit_table_body">
                            		<s:iterator value="stockIncomeBill.stockIncomeBillItem">
	                                    ...
	                                    <td>
	                                    	<s:textfield disabled="true"  tag="costPrice" name="costPrice" cssClass="ui_input_txt02"/>
	                                    </td>
	                                    <td>
