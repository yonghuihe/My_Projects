...
<body>
	...
	<s:form name="editForm" action="stockIncomeBill_save" method="post" id="editForm">
		<div id="container">
			<div id="nav_links">
			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
					...
					<tr>
						...
						<td class="ui_text_lt">
							<s:select list="#depots" name="stockIncomeBill.depot.id" listKey="id" listValue="name" cssClass="ui_input_txt04"/>
						</td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">业务时间</td>
						<td class="ui_text_lt">
							<s:date name="stockIncomeBill.vdate" format="yyyy-MM-dd" var="datefmt" />
							<s:textfield name="stockIncomeBill.vdate" value="%{#datefmt}" cssClass="ui_input_txt02 Wdate" onclick="WdatePicker();"/>
						</td>
					</tr>	
					<tr>
	                    ...
	                    <td>
	                        ...
	                        <table class="edit_table" cellspacing="0" cellpadding="0" border="0" style="width: auto">
	                            ...
	                            <tbody id="edit_table_body">
	                            	<s:if test="stockIncomeBill.id == null">
		                                <tr>
		                                    ...
		                                    <td>
		                                        ...
		                                        <s:hidden name="stockIncomeBill.stockIncomeBillItem[0].product.id" tag="pid"/>
		                                    </td>
		                                    <td>
		                                    	<span tag="brand"/>
		                                    </td>
		                                    <td>
		                                    	<s:textfield tag="costPrice" name="stockIncomeBill.stockIncomeBillItem[0].costPrice" cssClass="ui_input_txt02"/>
		                                    </td>
		                                    <td>
		                                    	<s:textfield tag="number" name="stockIncomeBill.stockIncomeBillItem[0].number" cssClass="ui_input_txt02"/>
		                                    </td>
		                                    <td>
		                                    	<span tag="amount"/>
		                                    </td>
		                                    <td>
		                                    	<s:textfield tag="remark" name="stockIncomeBill.stockIncomeBillItem[0].remark" cssClass="ui_input_txt02"/>
		                                    </td>
		                                    <td>
	                            	...
	                            	<s:else>
	                            		<s:iterator value="stockIncomeBill.stockIncomeBillItem">
	                            			<tr>
		                                    <td></td>
		                                    <td>
