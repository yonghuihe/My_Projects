				...
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_bottom">
							...
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-href='<s:url action="brand_input" />'/> 
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							<s:iterator value="#result.result" var="item">
								<tr>
									...
									<td>
										<s:a action="brand_input"><s:param name="brand.id" value="#item.id"/>编辑</s:a>
										<s:url action="brand_delete" var="delUrl">
											<s:param name="brand.id" value="#item.id"/>
										</s:url>
