...
<body>
	...
	<s:form name="editForm" action="systemMenu_save" method="post" id="editForm">
		<div id="container">
			<div id="nav_links">
				<span style="color: #1A5CC6;">SystemMenu编辑</span>
				<div id="page_close">
					<a>
			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
					...
					<tr>
						...
						<td class="ui_text_lt">
							<s:textfield name="#parentName" disabled="true" cssClass="ui_input_txt02"/>
							<s:hidden name="systemMenu.parent.id" value="%{queryObject.parentId}"/>
						</td>
					</tr>
					<tr>
