				...
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_bottom">
							...
							<input type="button" value="新增" class="ui_input_btn01 btn_input" data-href=<s:url value="role_input"/>>
						...
						<tbody>
							<s:iterator value="#result.result" var="rs">
								<tr>
									...
									<td>
										<s:a action="role_input"><s:param name="role.id" value="#rs.id"/>编辑</s:a>
										<s:a action="role_delete"><s:param name="role.id" value="#rs.id"/>删除</s:a>
										<s:url action="role_delete" var="delUrl">
											<s:param name="role.id" value="#rs.id"/>
										</s:url>
