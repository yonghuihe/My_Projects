...
<body>
	...
	<s:form name="editForm" action="stockOutcomeBill_save" method="post" id="editForm">
		<div id="container">
			<div id="nav_links">
			...
			<div class="ui_content">
				<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
					...
					<tr>
						...
						<td class="ui_text_lt">
							<s:select list="#depots" name="stockOutcomeBill.depot.id" listKey="id" listValue="name" cssClass="ui_input_txt04"/>
						</td>
					</tr>
					<tr>
						<td class="ui_text_rt" width="140">客户</td>
						<td class="ui_text_lt">
							<s:select list="#clients" name="stockOutcomeBill.client.id" listKey="id" listValue="name" cssClass="ui_input_txt04"/>
						</td>
					</tr>
					<tr>
						...
						<td class="ui_text_lt">
							...
							<s:textfield name="stockOutcomeBill.vdate" value="%{#datefmt}" cssClass="ui_input_txt02 Wdate" onclick="WdatePicker();"/>
						</td>
					</tr>	
					<tr>
	                            ...
	                            <tbody id="edit_table_body">
	                            	<s:if test="stockOutcomeBill.id == null">
		                                <tr>
		                                    ...
		                                    <td>
		                                        ...
		                                        <s:hidden name="stockOutcomeBill.stockOutcomeBillItem[0].product.id" tag="pid"/>
		                                    </td>
		                                    <td>
		                                    	<span tag="brand"/>
		                                    </td>
		                                    <td>
		                                    	<s:textfield tag="salePrice" name="stockOutcomeBill.stockOutcomeBillItem[0].salePrice" cssClass="ui_input_txt02"/>
		                                    </td>
		                                    <td>
		                                    	<s:textfield tag="number" name="stockOutcomeBill.stockOutcomeBillItem[0].number" cssClass="ui_input_txt02"/>
		                                    </td>
		                                    <td>
		                                    	<span tag="amount"/>
		                                    </td>
		                                    <td>
		                                    	<s:textfield tag="remark" name="stockOutcomeBill.stockOutcomeBillItem[0].remark" cssClass="ui_input_txt02"/>
		                                    </td>
		                                    <td>
	                            	...
	                            	<s:else>
	                            		<s:iterator value="stockOutcomeBill.stockOutcomeBillItem">
		                                    ...
		                                    <td>
		                                    	<s:textfield tag="salePrice" name="salePrice" cssClass="ui_input_txt02"/>
		                                    </td>
		                                    <td>
