$(function(){
	...
	$(".btn_submit").click(function(){
		...
		$.each($("#edit_table_body tr"),function(index,item){
			$(item).find("[tag='pid']").prop("name","stockIncomeBill.stockIncomeBillItem[" + index + "].product.id");
			$(item).find("[tag='costPrice']").prop("name","stockIncomeBill.stockIncomeBillItem[" + index + "].costPrice");
			$(item).find("[tag='number']").prop("name","stockIncomeBill.stockIncomeBillItem[" + index + "].number");
			$(item).find("[tag='remark']").prop("name","stockIncomeBill.stockIncomeBillItem[" + index + "].remark");
		})
		$("#editForm").submit();
	});
