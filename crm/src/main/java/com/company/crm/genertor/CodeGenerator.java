package com.company.crm.genertor;
...
public class CodeGenerator {
	...
	private static void codeGenerator(Class clazz) throws Exception {
		...
		//生成JSP页面和js
		createFile("target.jsp","src/main/webapp/WEB-INF/views/{2}/{2}.jsp",classInfo);
		createFile("target.js","src/main/webapp/static/js/{2}/{2}.js",classInfo);
