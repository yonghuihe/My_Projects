package com.company.crm.servlet;
...
public class CXFServletExtend extends CXFNonSpringServlet implements ApplicationListener<ContextRefreshedEvent> {
	...
	protected void loadBus(ServletConfig servletConfig) {
		// 使用spring监听器来启动时获取applicationContext
		/*
	...
	/**
	 * Try to create a spring application context from the config location. Will
	 * first try to resolve the location using the servlet context. If that does
	 * not work then the location is given as is to spring
	 * 
	 * @param ctx
	 * @param sc
