...
public class BidConst {
	...
	public static final BigDecimal DEFALUT_BORROWLIMITAMOUNT = new BigDecimal("2000.0000");//初始用户授信额度
	...
	//------------------------------------系统账户流水的类型--------------------------------------------
	public final static int SYSTEM_ACCOUNT_ACTIONTYPE_MANAGE_CHARGE = 1;//系统账户收到的账户管理费（借款管理费）
	public final static int SYSTEM_ACCOUNT_ACTIONTYPE_INTREST_MANAGE_CHARGE = 2;//系统账户收到的利息管理费
	public final static int SYSTEM_ACCOUNT_ACTIONTYPE_WITHDRAW_MANAGE_CHARGE = 3;//系统账户收到的提现管理费
	
	//-------------------------------------还款状态------------------------------------------------
	public final static int PAYMENT_STATE_NOMAL = 0;//正常待还
