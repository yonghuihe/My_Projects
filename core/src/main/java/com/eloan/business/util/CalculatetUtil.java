...
public class CalculatetUtil {
	...
	public static BigDecimal calAccountManagementCharge(BigDecimal bidRequestAmount) {
		BigDecimal accountManagementCharge = DecimalFormatUtil
				.formatBigDecimal(bidRequestAmount.multiply(ACCOUNT_MANAGER_CHARGE_RATE), BidConst.STORE_SCALE);
	 ...
	 */
	/*
	 * public static BigDecimal calAccountManagementCharge(BigDecimal
	 * bidRequestAmount,int monthes2Return) { BigDecimal accountManagementCharge
	 * = DecimalFormatUtil .formatBigDecimal( bidRequestAmount.multiply(
	 * BidConst.ACCOUNT_MANAGER_CHARGE_RATE).multiply( new
	 * BigDecimal(monthes2Return)), BidConst.SCALE); return
