...
public class BidRequestAuditHistoryServiceImpl implements IBidRequestAuditHistoryService {
	...
	public PageResult query(BidRequestAuditHistoryQueryObject qo) {
		...
		if(count > 0){
			List<BidRequestAuditHistory> list = this.bidRequestAuditHistoryMapper.query(qo);
	...
	@Override
	public List<BidRequestAuditHistory> queryForList(BidRequestAuditHistoryQueryObject qo) {
