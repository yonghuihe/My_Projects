...
<!--		<div class="b-line">
		...
		<span>
			<a href="/es/page.jsp"><img src="/static/images/img/b3.jpg"></a>
		</span>
				<a href="/es/page.jsp" class="aui-flex-box">新款上市</a>
			</div>
			<div class="aui-flex-item aui-flex-items">
		<span>
			<a href="/es/page.jsp"><img src="/static/images/img/b4.jpg"></a>
		</span>
				<a href="/es/page.jsp" class="aui-flex-box">最火产品</a>
			</div>
			<div class="aui-flex-item aui-flex-items">
		<span>
			<a href="/es/page.jsp"><img src="/static/images/img/k3.jpg"></a>
		</span>
				<a href="/es/page.jsp" class="aui-flex-box">热潮时代</a>
			</div>
		</div>
<%--		<div class="aui-title-h">
			<h2>新品必购</h2>
		...
		<span>
			...
			<div class="aui-flex-item aui-flex-items1 aui-flex-items2">
		<span>
			<a href="/es/page.jsp"><img src="/static/images/img/k2.jpg"></a>
		</span>
				<a href="page.jsp" class="aui-flex-box">
		...
		<span>
			...
			<div class="aui-flex-item aui-flex-items1 aui-flex-items2">
		<span>
			<a href="/es/page.jsp"><img src="/static/images/img/k5.jpg"></a>
		</span>
				<a href="/es/page.jsp" class="aui-flex-box">
					<h2>
		...
		<div class="aui-flex">
			<div class="aui-flex-item aui-flex-items1 aui-flex-items2">
		<span>
			<a href="/es/page.jsp"><img src="/static/images/img/b5.jpg"></a>
		</span>
				<a href="/es/page.jsp" class="aui-flex-box">
			...
			<div class="aui-flex-item aui-flex-items1 aui-flex-items2">
		<span>
			<a href="/es/page.jsp"><img src="/static/images/img/b6.jpg"></a>
		</span>
				<a href="/es/page.jsp" class="aui-flex-box">
		...
		<span>
			...
			<div class="aui-flex-item aui-flex-items1 aui-flex-items2">
		<span>
			<a href="/es/page.jsp"><img src="/static/images/img/b7.jpg"></a>
		</span>
				<a href="page.jsp" class="aui-flex-box">
		...
		<div class="aui-flex">
			<div class="aui-flex-item aui-flex-items1 aui-flex-items2">
		<span>
			<a href="/es/page.jsp"><img src="/static/images/img/k4.jpg"></a>
		</span>
				<a href="/es/page.jsp" class="aui-flex-box">
		...
		<div class="tab-bar tab-bottom">
			<a class="tab-button active" href="index.jsp"><i class="tab-button-icon icon icon-home"></i><span class="tab-button-txt">首页</span></a>
...
<%--			<a class="tab-button cached" href="car.html"><i class="tab-button-icon icon icon-car"></i><span class="tab-button-txt">购物车</span></a>--%>
			<a class="tab-button cached" href="me.jsp"><i class="tab-button-icon icon icon-my" ></i><span class="tab-button-txt">我的</span></a>
		</div>
	</div>
</div>
