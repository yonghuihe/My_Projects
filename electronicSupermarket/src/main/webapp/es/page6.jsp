...
<section class="header" style="position:inherit">
	<h2 class="title">雷蛇（Razer）DeathAdder 炼狱蝰蛇3500DPI 三色灯光版 3键有线游戏鼠标 黑色</h2>
	<div class="price ">
		<div class="current-price">
			<span class="current-price"><small>￥</small>398.00</span>
		</div>
...
<section class="content">
	...
	<div class="desc">
		<img src="/static/images/img/b7.jpg" width="100%">
