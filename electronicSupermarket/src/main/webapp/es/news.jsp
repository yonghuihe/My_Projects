...
<div class="aui-list-cells">
	<a href="javascript:;" class="aui-list-cell aui-list-cell-s">
		<div class="aui-list-cell-fl"><img src="/static/images/icon-png/tz-1.png"></div>
		<div class="aui-list-cell-cn">通知消息</div>
		<div class="aui-list-cell-fr"></div>
	</a>
	<a href="javascript:;" class="aui-list-cell aui-list-cell-s">
		<div class="aui-list-cell-fl"><img src="/static/images/icon-png/tz-2.png"></div>
		<div class="aui-list-cell-cn">互动消息</div>
		<div class="aui-list-cell-fr"></div>
	</a>
	<a href="javascript:;" class="aui-list-cell aui-list-cell-s">
		<div class="aui-list-cell-fl"><img src="/static/images/icon-png/tz-3.png"></div>
